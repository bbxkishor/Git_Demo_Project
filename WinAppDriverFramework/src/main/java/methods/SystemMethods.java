...
//	ConnectionsMethods connectionMethods = new ConnectionsMethods();
	 ...
	 * @return
	 */
	public static String[] getCurrentADSettings(WebDriver driver) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public static String deleteOU(WebDriver driver, String name) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public static void clickOUTableDropdown(WebDriver driver, String search) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public static void enterActiveDirectorySettings(String ip, String port, String domain, 
	 ...
	 * @throws InterruptedException
	 */
	public static void turnOnActiveDirectorySupport(WebDriver driver) throws InterruptedException {
		navigateToActiveDirectory(driver);
	 ...
	 * @throws InterruptedException
	 */
	public static void navigateToActiveDirectory(WebDriver driver) throws InterruptedException {
	 ...
	 */
	@Deprecated
	public static void timer(WebDriver driver) throws InterruptedException {
		Thread.sleep(2000);
	...
	public void activateVersion(WebDriver driver, String versionNumber, String boxillaIp) throws InterruptedException {
		...
		try {
			...
			sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, boxillaIp, "service moy restart");			//restart services if upgrade fails
...
//			SystemAll.uploadElement(driver).click();
	...
	public void activateBackup(WebDriver driver, String timeStamp) throws InterruptedException {
		...
		alert.accept();
		int counter = 0;
		while (LandingPage.spinner(driver).isDisplayed() && counter < 50) {
...
//		timer(driver);
//		String connectionTable = SeleniumActions.seleniumGetText(driver, ConnectionPage.connectiontable(driver));
...
//	}
	...
	public static void navigateToSystemSettings(WebDriver driver) throws InterruptedException {
		timer(driver);
		LandingPage.systemTab(driver).click();
		log.info("System Dropdown clicked");
		timer(driver);
	...
	public void changeNetwork(WebDriver driver, String newIP, String originalBoxilla, String recoveryIp) throws InterruptedException {
		...
		if (currentIp.contains(newIP)) {
			...
			try {
				...
				if(isBoxillaUp) {
					sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, originalBoxilla, "reboot");
					Thread.sleep(120000); 			//make sure box is up
					driver.navigate().to("https://" + newIP + "/");
				}else {
					if(originalBoxilla.equals(newIP)) {
						sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, recoveryIp, "reboot");
						Thread.sleep(120000); 			//make sure box is up
						driver.navigate().to("https://" + originalBoxilla + "/");
					}else {
						sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, newIP, "reboot");
						Thread.sleep(120000); 			//make sure box is up
...
//	}
	...
	private void executeLicensetestRakeTask(WebDriver driver, String databaseTable, int requiredUsers, String boxillaIp) {
		try {
			if (requiredUsers <= 325) {
				...
				//stop script
				String stopOutput = sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, boxillaIp, "initctl stop cloudium-example-licensetest");				
				Thread.sleep(15000);
				...
				String startOutput = sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, boxillaIp, command);
				if(startOutput.contains("start/running")) {					
					log.info("Started rake task : cloudium-example-licensetest.. Waiting for 1 minutes");
					Thread.sleep(60000);
				}
				//stop again
				sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, boxillaIp, "initctl stop cloudium-example-licensetest");
				Thread.sleep(15000);
				log.info("Rake task stopped");
			} else {
	...
	private void clearentries(WebDriver driver, String boxillaIp) throws InterruptedException {
		...
		sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, boxillaIp, "initctl start cloudium-example-licensetest");
		Thread.sleep(60000);
		sendCommandToBoxilla(TestBase.boxillaUsername, TestBase.boxillaPassword, boxillaIp, "initctl stop cloudium-example-licensetest");
		Thread.sleep(15000);
	}
